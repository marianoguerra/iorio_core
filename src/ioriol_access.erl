...
-export([new/1, new_req/1, update_req/2, is_authorized_for_grant/2,
         ...
         authenticate/3, authenticate/4, group_inherit/3]).
...
group_inherit(#state{auth_mod=AuthMod, auth_state=AuthState}, Group, Groups) ->
    AuthMod:group_inherit(AuthState, Group, Groups).
